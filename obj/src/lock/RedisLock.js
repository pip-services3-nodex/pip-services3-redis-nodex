 ...
 *     }
 */
class RedisLock extends pip_services3_components_nodex_3.Lock {
    constructor() {
        super(...arguments);
        ...
        this._lock = pip_services3_commons_nodex_1.IdGenerator.nextLong();
        this._timeout = 30000;
        this._retries = 3;
        this._client = null;
    }
    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (connection == null) {
                throw new pip_services3_commons_nodex_3.ConfigException(correlationId, 'NO_CONNECTION', 'Connection is not configured');
            }
    ...
    checkOpened(correlationId) {
        if (!this.isOpen()) {
            throw new pip_services3_commons_nodex_2.InvalidStateException(correlationId, 'NOT_OPENED', 'Connection is not opened');
        }
    }
